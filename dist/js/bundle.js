...
!(function (e, t, n) {
  function r(e, t) {
    ...
    var e, t, n, o, i, s, a;for (var l in y) {
    ...
    var e = t.body;return e || (e = a(w ? "svg" : "body"), e.fake = !0), e;
  }function c(e, n, r, o) {
    var i,
        s,
        c,
    ...
    function l() {
      ...
      if ((h = e[p], g = k.style[h], s(h, "-") && (h = d(h)), k.style[h] !== n)) {
    ...
    var s = e.charAt(0).toUpperCase() + e.slice(1),
        a = (e + " " + N.join(s + " ") + s).split(" ");return r(t, "string") || r(t, "undefined") ? p(a, t, o, i) : (a = (e + " " + x.join(s + " ") + s).split(" "), h(a, t, n));
  }function v(e, t, r) {
    return g(e, n, n, t, r);
  }var y = [],
      ...
      b = "Moz O ms Webkit",
      x = S._config.usePrefixes ? b.toLowerCase().split(" ") : [];S._domPrefixes = x;var _ = S._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];S._prefixes = _;w || !(function (e, t) {
    function n(e, t) {
      ...
      if ((n || (n = t), u)) return n.createElement(e);r || (r = i(n));var o;return o = r.cache[e] ? r.cache[e].cloneNode() : h.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e), !o.canHaveChildren || m.test(e) || o.tagUrn ? o : r.frag.appendChild(o);
    }function a(e, n) {
      if ((e || (e = t), u)) return e.createDocumentFragment();n = n || i(e);for (var o = n.frag.cloneNode(), s = 0, a = r(), l = a.length; l > s; s++) {
        o.createElement(a[s]);
      }return o;
    }function l(e, t) {
      ...
      e || (e = t);var r = i(e);return !S.shivCSS || f || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || l(e, r), e;
    }var f,
        u,
        d = "3.7.3",
        p = e.html5 || {},
    ...
    })();var S = { elements: p.elements || "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output picture progress section summary template time video", version: d, shivCSS: p.shivCSS !== !1, supportsUnknownElements: u, shivMethods: p.shivMethods !== !1, type: "default", shivDocument: c, createElement: s, createDocumentFragment: a, addElements: o };e.html5 = S, c(t), "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports && (module.exports = S);
  })("undefined" != typeof e ? e : this, t);var N = S._config.usePrefixes ? b.split(" ") : [];S._cssomPrefixes = N;var T = { elem: a("modernizr") };Modernizr._q.push(function () {
    delete T.elem;
  });var k = { style: T.elem.style };Modernizr._q.unshift(function () {
    delete k.style;
  }), S.testAllProps = g, S.testAllProps = v;var z = (S.testProp = function (e, t, r) {
    return p([e], n, t, r);
  }, S.testStyles = c);Modernizr.addTest("csstransforms", function () {
    return -1 === navigator.userAgent.indexOf("Android 2.") && v("transform", "scale(1)", !0);
  });var P = "CSS" in e && "supports" in e.CSS,
      j = "supportsCSS" in e;Modernizr.addTest("supports", P || j), Modernizr.addTest("csstransforms3d", function () {
    var e = !!v("perspective", "1px", !0),
        t = Modernizr._config.usePrefixes;if (e && (!t || "webkitPerspective" in E.style)) {
      var n,
          r = "#modernizr{width:0;height:0}";Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", z(r + n, function (t) {
        e = 7 === t.offsetWidth && 18 === t.offsetHeight;
      });
    }return e;
  }), Modernizr.addTest("csstransitions", v("transition", "all", !0)), Modernizr.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect), o(), i(C), delete S.addTest, delete S.addAsyncTest;for (var F = 0; F < Modernizr._q.length; F++) {
    Modernizr._q[F]();
